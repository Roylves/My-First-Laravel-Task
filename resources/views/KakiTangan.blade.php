...
<html>
    ...
    <head>
        ...
        <!-- Styles
             ================================================== -->
        <link rel="stylesheet" href="/css/kkt/css/build.min.css">
        <link rel="stylesheet" href="/css/kkt/css/price_slider.css">
        <link rel="stylesheet" href="/css/kkt/css/uservoice.css">
        <!-- Favicons + Touch Icons
             ================================================== -->
        <link rel="icon" href="/static/images/favicon.ico" type="image/x-icon">
        <link rel="apple-touch-icon" sizes="76x76" href="/static/lp/img/favicons/apple-touch-icon-76x76.png">
        <link rel="apple-touch-icon" sizes="120x120" href="/static/lp/img/favicons/apple-touch-icon-120x120.png">
        <link rel="apple-touch-icon" sizes="152x152" href="/static/lp/img/favicons/apple-touch-icon-152x152.png">
    </head>
    <body>
        <!-- Google Tag Manager -->
...
<!-- End Google Tag Manager -->
        ...
        <div class="wrapper">
                        ...
                        <nav class="navbar navbar-default">
                            <div class="container-fluid">
                                ...
                                <div class="navbar-header">
                                    ...
                                    <a href="/landing/home_v2" class="logo"><img src="/css/kkt/img/logo.svg" alt=""></a>
                                </div>
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="dropdown dropdown_opened_mob">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="/landing/hr">FREE HR SYSTEM</a></li>
                                                <li><a href="/landing/payroll">PREMIUM PAYROLL SYSTEM</a></li>
                                            </ul>
                                        </li>
                                        <li class="active"><a href="/landing/about">ABOUT</a></li>
                                        <li class="active"><a href="http://blog.kakitangan.com">Blog</a></li>
                                        <li><a href="/kktlogin" class="header_link">LOG IN</a></li>
                                        <li><a href="/kktsignup" class="btn btn_primary btn_sign">SIGN UP</a></li>
                                    </ul>
                                </div>
                                <!-- /.navbar-collapse -->
                            </div>
            ...
            <div class="content">
                <div class="head">
                    <div class="head_bg" style="background-image: url(/css/kkt/img/head01.jpg);"></div>
                    <div class="container container_table">
                        <div class="head_content">
                            ...
                            <a href="/signup" class="btn btn_default btn_signup">SIGN UP FOR FREE</a>
                        </div>
                    </div>
                    <div class="slide_block active">
                        ...
                        <div class="slide_block_img">
                            <img src="/css/kkt/img/maybank.svg" alt="">
                        </div>
                    </div>
                </div>
    ...
    <div class="range_details">
        ...
        <div class="range_details_value">
            <div class="value_mark">RM</div><span class="total_amount">0</span>
                                ...
                                <div class="block_bot">
                                    <a href="/signup" class="btn btn_default btn_signup">SIGN UP TODAY</a>
                                    <div class="help_text">
                                        WITH 1-MONTH TRIAL
                                    </div>
                                </div>
                            ...
                            <div id="owl-example" class="owl-carousel carousel_styled main_carousel">
                                <div class="carousel_item_content">
                                    ...
                                    <div class="carousel_item_body">
                                        We have been using <a href="/landing" class="link">Kakitangan.com</a> for a month now and
                ...
                <div class="container logos_wrap">
                    ...
                    <ul class="img_list clearfix">
                        <li class="img_list_item">
                            <a><img src="/css/kkt/img/logos/sinchew.png" alt="sinchew"></a>
                        </li>
                        <li class="img_list_item">
                            <a><img src="/css/kkt/img/logos/alliance.png" alt="alliance-bank"></a>
                        </li>
                        <li class="img_list_item">
                            <a><img src="/css/kkt/img/logos/vulcan-post-logo.png" alt="vulcan-post"></a>
                        </li>
                        <li class="img_list_item">
                            <a><img src="/css/kkt/img/logos/bfm.png" alt="bfm"></a>
                        </li>
                        <li class="img_list_item">
                            <a><img src="/css/kkt/img/logos/china-press.png" alt="china-press"></a>
                        </li>
                        <li class="img_list_item">
                            <a><img src="/css/kkt/img/logos/eNanyang_logo.png" alt="nanyang"></a>>
                        </li>
                    </ul>
                </div>
                <div class="gray_block">
                            ...
                            <div id="owl-example2" class="owl-carousel carousel_styled simple_carousel">
                                <div class="simple_carousel_item_content">
                                    <div class="simple_carousel_item_img">
                                        <img src="/css/kkt/img/alliance-bank-innovation.png" alt="alliance-bank">
                                    </div>
                                ...
                                <div class="simple_carousel_item_content">
                                    <div class="simple_carousel_item_img">
                                        <img src="/css/kkt/img/maybank.png" alt="maybank">
                                    </div>
                                    <div class="simple_carousel_item_text">
                                ...
                                <div class="simple_carousel_item_content">
                                    <div class="simple_carousel_item_img">
                                        <img src="/css/kkt/img/cradle.png" alt="Cradle">
                                    </div>
                                    <div class="simple_carousel_item_text">
                                ...
                                <div class="simple_carousel_item_content">
                                    <div class="simple_carousel_item_img">
                                        <img src="/css/kkt/img/magic.png" alt="">
                                    </div>
                                    <div class="simple_carousel_item_text">
        ...
        <!-- Footer
             ================================================== -->
        <p class="text-center">
            <a href="/landing/terms">Terms and conditions</a>
        </p>
        <footer class="footer">
            <div class="container">
                <div class="row">
        ...
        <script src="/css/kkt/js/build.min.js"></script>
        <script src="/css/kkt/js/price_slider.js"></script>
        <script src="/css/kkt/js/uservoice.js"></script>
        <!-- End Document
             ================================================== -->
    </body>
</html>