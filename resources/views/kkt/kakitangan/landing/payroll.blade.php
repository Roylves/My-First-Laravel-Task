...
<!-- Mirrored from kakitangan.com/landing/payroll by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2017 10:36:43 GMT -->
...
<!-- End Google Tag Manager -->
  ...
  ================================================== -->
            ...
            <nav class="navbar navbar-default">
              <div class="container-fluid">
                ...
                <div class="navbar-header">
                  ...
                  <a href="../index.html" class="logo"><img src="../static/lp/img/layout/logo.svg" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="../login.html" class="header_link">LOG IN</a></li>
                    <li><a href="../signup.html" class="btn btn_primary btn_sign">SIGN UP</a></li>
                  </ul>
                </div>
                <!-- /.navbar-collapse -->
              </div>
      ...
      <div class="content">
        <div class="head mob_pb">
          <div class="head_bg" style="background-image: url(../static/lp/img/head03.jpg);"></div>
          <div class="container container_table">
            <div class="head_content">
              <h2>
                Simplified Payroll,<br> Secured Data.
              </h2>
              <div class="subtitle">
                We take one of the most tedious monthly processes and turn it<br> into something wonderful. Plus, we're always adding new features<br> to create a complete one-stop HR platform.
              </div>
              <span class="block_bot">
        ...
        <div class="container img_block">
          <h4>
            Payroll Automation
          </h4>
          <div class="subtitle">
            Discover our many premium features, integrated with <br> Kakitangan.com's leave application and employee database!
          </div>
          <div class="img_wrap">
            <img src="../static/lp/img/payroll_info.jpg" alt="">
          </div>
        </div>
        <div class="tabs_outher">
          <div class="container">
            <div class="tabs_inner">
              <ul class="custom_tabs clearfix">
                <li class="tab_link" data-tab="tab-1">
                  <div class="tab_head one">
                    <i class="icon top_icon icon_calc"></i>
                    <div class="tab_title">Automatic Payroll Calculations</div>
                    <div class="tab_text">Stop worrying about calculating employee deductions, let our calculator do that for you.</div>
                    <a href="#" class="link_more">Learn More</a>
                    <a href="#" class="link_close_more">
                      <i class="icon icon_arrow_up"></i>
                    </a>
                  </div>
                  <div id="tab-1" class="custom_tabs_content">
                    <div class="row">
                      <div class="col-sm-7 tabs_content_img">
                        <img src="../static/lp/img/tab_img.png" alt="">
                      </div>
                      <div class="col-sm-5 tabs_content_text">
                        <div class="tab_title">Automatic Calculations</div>
                        <ul class="default_list">
                          <li>&bull; Automatic calculations for EPF/SOCSO/LHDN</li>
                          <li>&bull; Minimum monthly data updating work</li>
                          <li>&bull; No "patch file" downloading and installation needed</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                </li>
                <li class="tab_link" data-tab="tab-2">
                  <div class="tab_head two">
                    <i class="icon top_icon icon_dollar"></i>
                    <div class="tab_title">Automatic Transactions</div>
                    <div class="tab_text">Our system will remember and make the transactions to your employees accounts, that's one less concern for you.</div>
                    <a href="#" class="link_more">Learn More</a>
                    <a href="#" class="link_close_more">
                      <i class="icon icon_arrow_up"></i>
                    </a>
                  </div>
                  <div id="tab-2" class="custom_tabs_content">
                    <div class="row">
                      <div class="col-sm-7 tabs_content_img">
                        <img src="../static/lp/img/tab_img.png" alt="">
                      </div>
                      <div class="col-sm-5 tabs_content_text">
                        <div class="tab_title">Automatic Transactions</div>
                        <ul class="default_list">
                          <li>&bull; Integration with local banks</li>
                          <li>&bull; Make all your online payments for salary/EPF/SOCSO/LHDN in one place</li>
                          <li>&bull; Easily ensure salary is paid on time</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                </li>
                <li class="tab_link" data-tab="tab-3">
                  <div class="tab_head three">
                    <i class="icon top_icon icon_doc"></i>
                    <div class="tab_title">Automatic Pay Slip Distribution</div>
                    <div class="tab_text">Your employees will receive their payslips without you having to lift a finger!</div>
                    <a href="#" class="link_more">Learn More</a>
                    <a href="#" class="link_close_more">
                      <i class="icon icon_arrow_up"></i>
                    </a>
                  </div>
                  <div id="tab-3" class="custom_tabs_content">
                    <div class="row">
                      <div class="col-sm-7 tabs_content_img">
                        <img src="../static/lp/img/tab_img.png" alt="">
                      </div>
                      <div class="col-sm-5 tabs_content_text">
                        <div class="tab_title">Automatic Pay Slip Distribution</div>
                        <ul class="default_list">
                          <li>&bull; Employees will receive their payslips automatically.</li>
                          <li>&bull; Reduce administrative effort in printing and distributing paper slips</li>
                          <li>&bull; Employees have easy online access to previous months’ payslips</li>
                          <li>&bull; Save HR lots of time!</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                </li>
                <li class="tab_link" data-tab="tab-4">
                  <div class="tab_head four">
                    <i class="icon top_icon icon_lock"></i>
                    <div class="tab_title">Safe and <br> Secure</div>
                    <div class="tab_text">We host your database on the world's no.1 cloud infrastructure for your convenience and security.</div>
                    <a href="#" class="link_more">Learn More</a>
                    <a href="#" class="link_close_more">
                      <i class="icon icon_arrow_up"></i>
                    </a>
                  </div>
                  <div id="tab-4" class="custom_tabs_content">
                    <div class="row">
                      <div class="col-sm-7 tabs_content_img">
                        <img src="../static/lp/img/tab_img.png" alt="">
                      </div>
                      <div class="col-sm-5 tabs_content_text">
                        <div class="tab_title">Safe and Secure</div>
                        <ul class="default_list">
                          <li>&bull; Laptop stolen? Enjoy peace of mind that your data is safe with us</li>
                          <li>&bull; Hosted on secured cloud server and is HTTPS-encrypted</li>
                          <li>&bull; PDPA-compliant data protection policies</li>
                        </ul>
                      </div>
                    </div>
                  </div>
    ...
    <div class="range_details">
        ...
        <div class="range_details_value">
          ...
          <div class="range_btn_wrap block_bot">
            <a href="../signup.html" class="btn btn_default btn_signup">SIGN UP FOR FREE</a>
            <div class="help_text">
              WITH 1-MONTH FREE TRIAL
            </div>
              ...
              <div id="owl-example" class="owl-carousel carousel_styled main_carousel">
                <div class="carousel_item_content">
                  ...
                  <div class="carousel_item_body">
                    We have been using <a href="index.html" class="link">Kakitangan.com</a> for a month now and
...
<!-- Mirrored from kakitangan.com/landing/payroll by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Feb 2017 10:36:44 GMT -->
</html>
